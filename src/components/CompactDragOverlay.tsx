...
export function CompactDragOverlay({ project }: CompactDragOverlayProps) {
  return (
    <div className="flex items-center gap-3 px-4 py-3 bg-background border-2 border-primary/50 rounded-lg shadow-2xl pointer-events-none z-50 max-w-64 backdrop-blur-sm">
      <div 
