-- First delete all existing project assignments to start fresh
...
SELECT 
  ...
  CASE np.team_id
    ...
    WHEN '8e18a4fa-94e4-4b23-a68f-ba4fd9c5'::uuid THEN '5e3934c7-36bc-444e-a8eb-5bbe8388e388'::uuid -- Jan Burks for OPA
