-- Insert 20 fake projects with realistic data (avoiding conflicts)
...
-- Assign team members to projects (one assignee per project to avoid conflicts)
-- Get the newly created project IDs and assign team members
...
SELECT 
  np.id,
  CASE np.team_id
    WHEN 'b0878bff-71b7-41cc-9d9e-d776103940f3' THEN 'f243e222-ba03-452b-9e42-02bab630aed0' -- Alice Johnson for Engineering
    WHEN '5a27eb80-4e1d-423a-89b6-7cbf6e92860a' THEN '2a24f557-49fd-4390-932b-0c4ad4c732bb' -- Carol Williams for Product
    WHEN 'fbd5c124-a31d-446d-889c-e12e71567448' THEN '05f4da5f-1f93-469f-8787-9f45060582e7' -- Nick Fernandez for Processing
    WHEN 'd13c1c5f-46ec-4634-a665-c9f343d91b5b' THEN '077d43e9-3d84-410b-aec0-7fc581ba1834' -- Eve Davis for Client Back Office
    WHEN '14b9e5ab-9dd4-4888-9cfd-975f02fbd9c5' THEN '77dde75b-917a-4f4a-a3c2-f60407e4a855' -- Jill Scott for POS
    WHEN '8e18a4fa-94e4-4b23-a68f-ba4fd3be3e57' THEN '5e3934c7-36bc-444e-a8eb-5bbe8388e388' -- Jan Burks for OPA
